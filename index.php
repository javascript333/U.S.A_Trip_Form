...
<body>
    <img class="bg" src="images/dbit15.jpg" alt="DBIT Bangalore">
    <div class="container">
        <h1>DBIT US TRIP FORM</h1>
        <p>Enter your details and submit this form
         to confirm your participation in the trip</p>
         <?php
            if($insert == true){
